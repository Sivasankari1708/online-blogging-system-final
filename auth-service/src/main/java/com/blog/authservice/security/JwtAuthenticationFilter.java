 ...
 * If valid, sets the Authentication in the SecurityContext so Spring Security
 * treats the request as authenticated.
 * No database call is made — authentication is derived entirely from the token.
 */
@Component
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (jwtUtil.isTokenValid(token) &&
            ...
            // Create authentication token — no authorities needed for simple auth
